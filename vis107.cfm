...
<cfajaxproxy cfc="vis107" jsclassname="TDF">
<cfajaximport>
...
function csvfp_all()
{
 ...
 frm.append('input').attr('type','hidden').attr('name','rdCert').attr('value','Y'); 
...
var temp_rc = 'darkrow';	
 ...
 var thead = tb.append('thead');
   thead.on('wheel', function() {d3.event.preventDefault();  (d3.event.deltaY <0) ? d3.select('#datatable2').style('zoom',t2zoom/1 +.02) : d3.select('#datatable2').style('zoom',t2zoom/1 -.02); t2zoom =  d3.select('#datatable2').style('zoom') }) 
...
//    	 e.setHTTPMethod("POST");
		...
		e.getFailedPcsData('<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
...
//	    e.setHTTPMethod("POST");
		...
		e.setErrorHandler(area_data_err);
		e.getFailedPcszip3('<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
 ...
 function getenddate(v)
  {
	...
	function cfrm_sub()
	{
		...
		e.setErrorHandler(area_data_err);
		e.getByMailerData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,szip3,sorg,seodt,sindc);
        if (sdir == 'O')
		{
		var e=new TDF();
		e.setCallbackHandler(zip3_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDestZip3(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		} else
		{
		var e=new TDF();
		e.setCallbackHandler(orgfac_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByOrgFacData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		}
		var e=new TDF();
		e.setCallbackHandler(Display_Overalls);	
		e.setErrorHandler(area_data_err);
		e.getByOverallData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Area_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAreaData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(District_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDistData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Facility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFacilityData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,srng,smlr,szip3,sorg,seodt,sindc);
<!---		var e=new TDF();
		...
		e.setErrorHandler(area_data_err);
		e.getByCntrData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Class_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByClassData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Cat_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByCatData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(EOD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByEODData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(SVCSTD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySvcStdData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Air_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAir(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(FSS_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFSS(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(pol_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByPolitical(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(enttype_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByEntType(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(induct_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByInductMthd(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
...
<div id="chartsdiv" style='width:1570px'>
