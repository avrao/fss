<!doctype html>
<cfajaxproxy cfc="visPMRCsnapshot" jsclassname="TDF">
<cfajaximport>
...
<script>
	...
	function RCT_Chart(res)
	{
		var resId = res.pop()[0];
			...
			chartHistory[resId].RCT_Chart=(function(data){
				return function(){
					streamLineChart(data,'selRootType','chart-RCT','svgRCT','Root Type','loader');		
				}
			})(res)
		if(ReqId != resId)
		{
		...
		streamLineChart(res,'selRootType','chart-RCT','svgRCT','Root Type','loader');		
	}
	...
	function cfrm_sub()
	{
		...
		e.setErrorHandler(area_data_err);
		e.getByOverallData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(OArea_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByOAreaData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,sda,sdd,sdf,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(DArea_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDAreaData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sod,sof,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(ODistrict_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByODistData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sdd,sdf,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(DDistrict_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDDistData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sof,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(OFacility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByOFacilityData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sdf,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(DFacility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDFacilityData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,srp,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(RootFacility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByRootFacilityData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,ssst,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(SST_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySSTData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,sm,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(Mode_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByModeData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sssc,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(SSC_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySSCData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,ss,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(Shape_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByShapeData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,sssc,srt,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(RCT_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByRCTData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,sssc,ss,sr,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(Root_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByRootData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,sssc,ss,srt,stc,stpc);
		var e=new TDF();
		e.setCallbackHandler(STC_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySTCData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,sssc,ss,srt,sr,stpc);
		var e=new TDF();
		e.setCallbackHandler(StopTC_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByStopTCData(ReqId,'<cfoutput>#datasource#</cfoutput>',sd,sdend,soa,sda,sod,sdd,sof,sdf,srp,ssst,sm,sssc,ss,srt,sr,stc);
...
<div id='filtDiv'>
	...
	<fieldset class="fset"><legend>Date By:</legend>
		...
		<input class ="slct" id="daily" type = "radio" value = "Daily" name='DRANGE' onclick="var e=new TDF();e.setCallbackHandler(load_Dates);e.setErrorHandler(area_data_err);e.getDates('<cfoutput>#opsvisdata#</cfoutput>','');" checked>Daily
		<input class ="slct" id="Weekly" type = "radio" value = "Weekly" name='DRANGE' onclick="var e=new TDF();e.setCallbackHandler(load_Dates);e.setErrorHandler(area_data_err);e.getDates('<cfoutput>#opsvisdata#</cfoutput>','WK');">Weekly
	</fieldset>
...
<h2>Priority Mail Root Cause [DEV]</h2><iframe id="txtArea1" style="display:none"></iframe>
...
<div style='min-width:1260px;min-height:250px;text-align:left;margin:0 0 0 15%;'>
...
<div id='tblBlockMove' style='border:gray outset 3px;min-height:18px;min-width:97%;background:#21435F;'><img src ='images/close_icon.png' class = 'imgbtn' style="float:right" onMouseDown="d3.select('#tblBlockParent').call(d3.behavior.drag().on('drag', null));d3.select('#tblBlockParent').on('mousedown.drag',null);d3.select('#tblBlockParent').style('display','none');event.stopPropagation();"/></div>
<div id='tblBlock' style='padding: 3px;border: solid 2px blue;background:#f3f3f3;'></div>
</div>
<div id='chrtSpace' style='margin:0 0 0 15%;text-align:left;min-width:1260px;'>
<div style='min-width:99%;text-align:left;margin: 0 auto;'>
<div id="chart-OArea" style="display:inline-block;"></div>
<div id="chart-ODistrict" style="display:inline-block;"></div>
<div id="chart-OFacility" style="display:inline-block;"></div>
</div>
<br>
<div style='min-width:99%;text-align:left;margin: 0 auto;'>
<div id="chart-DArea" style="display:inline-block;"></div>
<div id="chart-DDistrict" style="display:inline-block;"></div>
<div id="chart-DFacility" style="display:inline-block;"></div>
</div>
<br>
<div style='min-width:99%;text-align:left;margin: 0 auto;'>
<div id="chart-RFacility" style="display:inline-block;"></div>
<div id="chart-SST" style="display:inline-block;"></div>
<div id="chart-Mode" style="display:inline-block;"></div>
</div>
<br>
<div style='min-width:99%;text-align:left;margin: 0 auto;'>
<div id="chart-SSC" style="display:inline-block;"></div>
<div id="chart-Shape" style="display:inline-block;"></div>
<div id="chart-RCT" style="display:inline-block;"></div>
</div>
<br>
<div style='min-width:99%;text-align:left;margin: 0 auto;'>
<div id="chart-Root" style="display:inline-block;"></div>
<div id="chart-STC" style="display:inline-block;"></div>
<div id="chart-StopTC" style="display:inline-block;"></div>
</div>
</div>
