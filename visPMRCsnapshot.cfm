...
<script>
	...
	function init()
	{
		...
		var tdy = new Date();
		var dtchck = new Date('01/06/2017');
		if(tdy - dtchck > 0)
			d3.select('#subtitlemsg').style('display','none');
...
<h2>Package Performance Processing</h2>
<h5 id='subtitlemsg' style='margin: 0; position:relative;top:-18px;'>PM 2D-3D start dates 11/23-12/31 receive add’l delivery day</h5>
...
<br>
<div style='min-width:99%;text-align:left;margin: 0 auto;'>
<div id="chart-ProCode" style="display:inline-block;"></div>
</div>
</div>
