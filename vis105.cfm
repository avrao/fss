...
<cfajaxproxy cfc="vis105" jsclassname="TDF">
<cfajaximport>
...
<script>
	...
	{	
		...
		*/
		...
		streamLineChart(res,'selImbZip3','chart-zip3','svgzip3','Destination Zip3','loader');		
	}
 ...
 function getenddate(v)
  {
	...
	function cfrm_sub()
	{
		...
		e.setErrorHandler(area_data_err);
		e.getByOverallData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(Area_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAreaData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(District_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDistData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(Facility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFacilityData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(Mailer_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByMailerData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,szip3);
<!---		var e=new TDF();
		...
		e.setErrorHandler(area_data_err);
		e.getByCntrData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(Class_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByClassData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(Cat_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByCatData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(EOD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByEODData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(SVCSTD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySvcStdData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(Air_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAir(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(FSS_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFSS(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
		var e=new TDF();
		e.setCallbackHandler(zip3_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDestZip3(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,"Y",spol,shyb,'',sDOW,sfac,srng,smlr,szip3);
...
<div id="chart-zip3" style="display:inline-block;max-width:380px;"></div>
</div>
