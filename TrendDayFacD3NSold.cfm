...
<script>
	...
	{	
		...
		if(!scheck)
		{
			...
			tle.append("tspan").attr('display','block').text(function(d,i) {return 'Total Pieces: '+comF(res[i][4]);})
			tle.append("tspan").attr('display','block').text(function(d,i) {return 'Percent: '+perF(res[i][3]);})		
	...
	function cfrm_sub()
	{
		...
		e.setErrorHandler(area_data_err);
		e.getByOverallData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
		var e=new TDF();
		e.setCallbackHandler(Area_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAreaData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sMail);
		var e=new TDF();
		e.setCallbackHandler(District_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDistData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sMail);
		var e=new TDF();
		e.setCallbackHandler(Facility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFacilityData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sMail);
		var e=new TDF();
		e.setCallbackHandler(DOW_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDayData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
		var e=new TDF();
		e.setCallbackHandler(Class_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByClassData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
		var e=new TDF();
		e.setCallbackHandler(Cat_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByCatData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
		var e=new TDF();
		e.setCallbackHandler(EOD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByEODData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
		var e=new TDF();
		e.setCallbackHandler(SVCSTD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySvcStdData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
		var e=new TDF();
		e.setCallbackHandler(MLR_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByMlrData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac);
		...
		e.setCallbackHandler(Gather_Trend_Data);	
		e.setErrorHandler(area_data_err);
		e.getByOverallData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,makeDate(dateVari),sdend,sarea,sdist,sclass,scat,sfss,"","","","Y",spol,shyb,'',sDOW,sfac,sMail);
	...
	function Gather_Trend_Data(res)
	{
		if(ReqId != res.pop()[0])
			return;
		res.shift();
		Trend_Data.push(res.shift());
		if(Trend_Data.length == 8)
		{
			Trend_Data.sort(function(a, b){return new Date(a[5])-new Date(b[5])});
			Load_Trend_Graph(Trend_Data);
		}
	}
	...
	{	
		...
		if(svg.node())
		{
			...
			fpie.enter()
				   ...
				   .attr("width",rw-4)
				   .attr("fill", function(d) {return cScale2(d[3]);}) .append('title')
			...
			fpie.transition().duration(500).attr("x", function(d,i) { return xScale(new Date(d[5]))-rw/2+2;})
				   ...
				   .attr("height",  function(d) {return Math.abs(yScale(d[2])-yScale(0));})
				   .attr("width",rw-4)
				   .attr("fill", function(d) {return cScale2(d[3]);})
			...
			*/
			...
			svg.append("linearGradient")
				...
				.data([
					...
					{offset: "69%", color: "#d73027"},
					{offset: "70%", color: "#fc8d59"},
					{offset: "79%", color: "#fc8d59"},
					{offset: "80%", color: "#fee090"},
					{offset: "89%", color: "#fee090"},
					{offset: "90%", color: "#91bfdb"},
					{offset: "94%", color: "#91bfdb"},
					{offset: "95%", color: "#4575b4"},
...
/*		
	...
	function Diag_Report_Lnk(N,place)
	{
		...
		*/
		...
		lnkForm.append("input").attr("type","hidden").attr("name","selDest3").attr("value",'');
		lnkForm.append("input").attr("type","hidden").attr("name","selPhysCntr").attr("value",'');
		lnkForm.append("input").attr("type","hidden").attr("name","selDestFac").attr("value",sfac);
		lnkForm.append("input").attr("type","hidden").attr("name","selImbZip3").attr("value",'');
...
<div id="trend-Graph" style="float:right;text-align:center; min-width:50%;"></div>
...
<div style='min-width:99%;margin:0px 20%;'>
...
<div id="color-key" style='margin:50px;float:left;'>
	...
	<div style="height:24px;">
		<div style="display:inline-block;height:20px;width:20px;border:1px black solid;background-color:#4575b4"></div><span>Score 95&ndash;100%</span>
	</div>
	<div style="height:24px;">
		<div style="display:inline-block;height:20px;width:20px;border:1px black solid;background-color:#91bfdb"></div><span>Score 90&ndash;95%</span>
	</div>
	<div style="height:24px;">
		<div style="display:inline-block;height:20px;width:20px;border:1px black solid;background-color:#fee090"></div><span>Score 80&ndash;90%</span>
	</div>
	<div style="height:24px;">
		<div style="display:inline-block;height:20px;width:20px;border:1px black solid;background-color:#fc8d59"></div><span>Score 70&ndash;80%</span>
	</div>
	<div style="height:24px;">
		<div style="display:inline-block;height:20px;width:20px;border:1px black solid;background-color:#d73027"></div><span>Score 0&ndash;70%</span>
	</div>
</div>
...
<div id="chart-MLR" style="display:inline-block;max-width:380px;"></div>
</div>
<br>
<div style='min-width:99%;text-align:center;margin: 0 auto;'>
<div id="chart-Entry" style="display:inline-block;max-width:380px;"></div>
<div id="chart-Level" style="display:inline-block;max-width:380px;"></div>
</div>
