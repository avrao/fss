...
<cfajaxproxy cfc="vis108" jsclassname="TDF">
<cfajaximport>
...
function csvfp_all()
{
 ...
 frm.append('input').attr('type','hidden').attr('name','selCert').attr('value','Y'); 
		...
		if(scheck)
		{
			...
			.on('click',(function(AR,pID,cID,chID,title,LID,rng){
				return function doSe(){
					d3.select('#searchBlock').style('display','').style('top',window.innerHeight/3+window.scrollY+'px');
...
//    	 e.setHTTPMethod("POST");
		...
		e.getFailedPcsData('<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
...
//	    e.setHTTPMethod("POST");
		...
		e.setErrorHandler(area_data_err);
		e.getFailedPcszip3('<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
 ...
 function getenddate(v)
  {
	...
	function cfrm_sub()
	{
		...
		e.setErrorHandler(area_data_err);
		e.getByMailerData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc,smflag);
        if (sdir == 'O')
		{
		var e=new TDF();
		e.setCallbackHandler(zip3_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDestZip3(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		} else
		{
		var e=new TDF();
		e.setCallbackHandler(orgfac_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByOrgFacData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		}
		var e=new TDF();
		e.setCallbackHandler(Display_Overalls);	
		e.setErrorHandler(area_data_err);
		e.getByOverallData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Area_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAreaData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(District_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByDistData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Facility_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFacilityData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,srng,smlr,szip3,sorg,seodt,sindc);
<!---		var e=new TDF();
		...
		e.setErrorHandler(area_data_err);
		e.getByCntrData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Class_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByClassData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Cat_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByCatData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(EOD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByEODData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(SVCSTD_Chart);	
		e.setErrorHandler(area_data_err);
		e.getBySvcStdData(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(Air_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByAir(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(FSS_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFSS(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(pol_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByPolitical(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(enttype_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByEntType(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(induct_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByInductMthd(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
		var e=new TDF();
		e.setCallbackHandler(fullsvc_Chart);	
		e.setErrorHandler(area_data_err);
		e.getByFuLLSvc(ReqId,'<cfoutput>#opsvisdata#</cfoutput>',srlupv,sdir,seod,sd,sdend,sarea,sdist,sclass,scat,sfss,smode,sair,scntr,scert,spol,shyb,'',sDOW,sfac,srng,smlr,szip3,sorg,seodt,sindc);
...
<div id='chRow' style="display:inline-block;margin:5px;"><select class ="slctSmall" onchange = "chartsperrow(this)">
